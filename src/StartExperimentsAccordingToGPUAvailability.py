...
'''
Experiments_proto = [{'--path': '20newsgroup', '--model_method': 'DocSCAN_finetuning_multi', '--threshold': 0.95,
				'--num_epochs': 5, '--augmentation_method': 'Deletion', '--ratio_for_deletion': 0.01},
			   {'--path': '20newsgroup', '--model_method': 'DocSCAN_finetuning_multi', '--threshold': 0.95,
				'--num_epochs': 5, '--augmentation_method': 'Deletion', '--ratio_for_deletion': 0.02},
			   {'--path': '20newsgroup', '--model_method': 'DocSCAN_finetuning_multi', '--threshold': 0.95,
				'--num_epochs': 5, '--augmentation_method': 'Deletion', '--ratio_for_deletion': 0.03},
			   {'--path': '20newsgroup', '--model_method': 'DocSCAN_finetuning_multi', '--threshold': 0.95,
				'--num_epochs': 5, '--augmentation_method': 'Deletion', '--ratio_for_deletion': 0.05},
			   {'--path': '20newsgroup', '--model_method': 'DocSCAN_finetuning_multi', '--threshold': 0.95,
				'--num_epochs': 5, '--augmentation_method': 'Deletion', '--ratio_for_deletion': 0.075},
			   {'--path': '20newsgroup', '--model_method': 'DocSCAN_finetuning_multi', '--threshold': 0.95,
				'--num_epochs': 5, '--augmentation_method': 'Deletion', '--ratio_for_deletion': 0.1},
			   {'--path': '20newsgroup', '--model_method': 'DocSCAN_finetuning_multi', '--threshold': 0.95,
				'--num_epochs': 5, '--augmentation_method': 'Deletion', '--ratio_for_deletion': 0.15},
			   {'--path': '20newsgroup', '--model_method': 'DocSCAN_finetuning_multi', '--threshold': 0.95,
				'--num_epochs': 5, '--augmentation_method': 'Deletion', '--ratio_for_deletion': 0.2},
			{'--path': '20newsgroup', '--model_method': 'DocSCAN_finetuning_multi', '--threshold': 0.99,
				'--num_epochs': 5, '--augmentation_method': 'Deletion', '--ratio_for_deletion': 0.01},
			   {'--path': '20newsgroup', '--model_method': 'DocSCAN_finetuning_multi', '--threshold': 0.99,
				'--num_epochs': 5, '--augmentation_method': 'Deletion', '--ratio_for_deletion': 0.02},
			   {'--path': '20newsgroup', '--model_method': 'DocSCAN_finetuning_multi', '--threshold': 0.99,
				'--num_epochs': 10, '--augmentation_method': 'Deletion', '--ratio_for_deletion': 0.03},
			   {'--path': '20newsgroup', '--model_method': 'DocSCAN_finetuning_multi', '--threshold': 0.99,
				'--num_epochs': 5, '--augmentation_method': 'Deletion', '--ratio_for_deletion': 0.05},
			   {'--path': '20newsgroup', '--model_method': 'DocSCAN_finetuning_multi', '--threshold': 0.99,
				'--num_epochs': 5, '--augmentation_method': 'Deletion', '--ratio_for_deletion': 0.075},
...
def start_experiment(experiment, device):
	...
	if experiment['--model_method'] == 'PrototypeAccuracy' and experiment['--embedding_model'] != 'IndicativeSentence':
		...
		outfile = f'NewSelflabelingExperiments/Dataset_{experiment["--path"]}_Em_IS_clustering_method_{experiment["--clustering_method"]}_model_method_{experiment["--model_method"]}_epochs_{experiment["--num_epochs"]}_indicativesentence_{experiment["--indicative_sentence"]}_entropy_weight_{experiment["--entropy_weight"]}_threshold_{experiment["--threshold"]}_augmentation_method_{experiment["--augmentation_method"]}_ratio_{experiment["--ratio_for_deletion"]}_new.txt'
