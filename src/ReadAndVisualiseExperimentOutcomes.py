...
def display_selflabeling_experiments():
    ...
    frame = frame[frame.Difference != 'Experiment not finished'].sort_values('Difference').sort_values(['Dataset','Augmentation Method', 'Embedding', 'Clustering Method', 'Difference'])
